...
// Intraducing the maximum number of hadcoins available for sale
uint public max_hadcoins = 1000000;

//Introducing the USD to hadcoins conversion rate
uint public usd_to_hadcoins = 1000;

//Introducing the to tal number of Hadcoins that have been bought by
//the investors
...
//Checking if an investor can but Hadcoins
...
//Buying Hadcoins
function by_hadcoins(address investor, uint usd_invested) external
...
//Selling Hadcoins
function sell_hadcoins(address investor, uint hadcoins_sold){
